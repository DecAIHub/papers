...
| 7 | Zero-shot LLM validation | `data/llm_validation_results.csv` | Per-pair human-vs-LLM judgments on the validation subsample (n = 66 pairs: 16 cross-family-stable + 50 negative controls). Source data for the LLM-comparison results reported in the abstract and §4 |
